                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <div style="text-align: right;">
                            <a href="/admin/blog/create" class="btn btn-primary"> <i class="fa fa-plus"></i> Create Blog</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr v-for="bl in blog">
                                    <td><b>@{{bl.title}}</b></td>
                                    <td v-html="$options.filters.liveSubstr(bl.content, 100)"></td>
                                    <td>
                                        <h5> <b><span class="badge badge-primary">@{{bl.categories?.name}}</span></b></h5>
                                    </td>
