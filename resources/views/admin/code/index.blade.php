                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr style="font-size: 14px;" v-for="(sc, index) in code">
                                    <td class="text-center">@{{index+1}}</td>
                                    <td>@{{sc.name}}</td>
                                    <td>@{{ sc.link_download }}</td>
                                    <td>@{{ sc.link_demo}}</td>
                                    <td>@{{sc.author_code}}</td>
                                    <td class="text-center">@{{sc.total_download ?? 0}}</span></td>
                                    <td><img :src="'/files/code/' + sc.image" width="100px"></td>

                                    <td style="width: 150px;">
                                        <div class="text-center">
                                            <a :href="'/admin/code/edit/' + sc.id">
                                            ...
                                            <a :href="'/admin/code/detail/' + sc.id">
                                            ...
                                            <button class="btn btn-danger" @click.prevent="deleteRecord(sc.id)" href="">
